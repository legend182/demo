...
if __name__ == '__main__':
    data_path = './data/BraTS2018_data'
    test_save_path = 'preditions/unet1/'
    save_mode_path = './checkpoint/UNet/checkpoint32.pth'
...
#         image_list = [os.path.join(data_path, x.strip()) for x in f.readlines()]
        image_list = [os.path.join(data_path, f"Brats18_{x.strip()}_mri_norm2.h5") for x in f.readlines()]
